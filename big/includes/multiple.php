...
#EDIT THE FOLLOWING:
$toAddress = "rileyapatterson@gmail.com";  //place your/your client's email address here
$toName = "Riley Patterson"; //place your client's name here
$website = "Web120 BIG Website";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>I will respond within 48 hours, if you are requesting information!</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
	...
	<div>	
		<label>
			...
			<select name="How_Did_You_Hear_About_Us?" required="required" title="How You Heard is required" tabindex="30">
				...
				<option value="Magazine">A Publication</option>
				<option value="A Friend">Word of Mouth</option>
	...
	<div>	
		<label>
			Additional Comments and/or Requests:<br /><textarea name="Comments" cols="56" rows="8" placeholder="Thank you for reaching out!" tabindex="60"></textarea>
		</label>
	</div>	
	<div></div>
