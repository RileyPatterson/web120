...
$toName = "Kelani"; //place your client's name here
$website = "Final Project Contact Form";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>I will try to respond to any requests or questions ithin  24 hours. Have a great day!</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
	...
	<div>	
		<label>
			Questions and/or Comments:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Your comments are important to us!" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
